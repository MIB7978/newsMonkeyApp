...
async   componentDidMount(){
      let url = "https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=377bfcc923ba4ce0ae00ae4e2cd01cb7"
        let data = await  fetch(url)
       let parsedata = await   data.json();
       console.log("response",parsedata.articles)
